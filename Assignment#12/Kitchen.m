...
- (Pizza *)makePizzaWithSize:(PizzaSize)size toppings:(NSArray *)toppings {
    ...
    if ([self.kitchenDelegate kitchen:self shouldMakePizzaOfSize:(PizzaSize)size andToppings:(NSArray *)toppings] == YES) {
        
        if ([self.kitchenDelegate kitchenShouldUpgradeOrder:self] == YES) {
            
            Pizza *pizza = [[Pizza new] init:kLarge toppings:toppings];
